...
YOLO_Lite_Model_Paper = nn.Sequential(nn.ZeroPad2d((1, 1, 1, 1)), #torch.Size([1, 3, 226, 226])
						nn.Conv2d(3,16,kernel_size=3, bias=False), #torch.Size([1, 16, 224, 224])
						...
						nn.ZeroPad2d((1, 1, 1, 1)), #torch.Size([1, 16, 114, 114])
						nn.Conv2d(16,32,kernel_size=3, bias=False), #torch.Size([1, 32, 112, 112])
						...
						nn.Conv2d(32, 64, kernel_size=3, bias=False), #torch.Size([1, 64, 56, 56])
						...
						nn.Conv2d(64, 128, kernel_size=3, bias=False), #torch.Size([1, 128, 28, 28])
						...
						nn.Conv2d(128, 128, kernel_size=3, bias=False), #torch.Size([1, 128, 14, 14])
						...
						nn.Conv2d(128, 256, kernel_size=3, bias=False), #torch.Size([1, 256, 7, 7])
...
Our_Layer_Model = nn.Sequential(nn.ZeroPad2d((1, 1, 1, 1)),
						GCK3x3Layer(3,16,kernel_size=3, bias=False, result_dim=224),
						...
						nn.ZeroPad2d((1, 1, 1, 1)),
						GCK3x3Layer(16,32,kernel_size=3, bias=False, result_dim=112),
						...
						nn.ZeroPad2d((1, 1, 1, 1)),
						GCK3x3Layer(32, 64, kernel_size=3, bias=False, result_dim=56),
						...
						nn.ZeroPad2d((1, 1, 1, 1)),
						GCK3x3Layer(64, 128, kernel_size=3, bias=False, result_dim=28),
						...
						nn.ZeroPad2d((1, 1, 1, 1)),
						GCK3x3Layer(128, 128, kernel_size=3, bias=False, result_dim=14),
						nn.BatchNorm2d(128, momentum=0.9, eps=1e-5),
						nn.LeakyReLU(0.1),
						...
						nn.ZeroPad2d((1, 1, 1, 1)),
						GCK3x3Layer(128, 256, kernel_size=3, bias=False, result_dim=7),
