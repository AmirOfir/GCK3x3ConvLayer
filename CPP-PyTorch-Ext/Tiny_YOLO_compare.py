...
Tiny_YOLO_Model_Paper = nn.Sequential(nn.ZeroPad2d((1, 1, 1, 1)), #torch.Size([1, 3, 418, 418])
						nn.Conv2d(3,16,kernel_size=3, bias=False), #torch.Size([1, 16, 416, 416])
						...
						nn.Conv2d(16,32,kernel_size=3, bias=False), #torch.Size([1, 32, 208, 208])
						...
						nn.Conv2d(32, 64, kernel_size=3, bias=False), #torch.Size([1, 64, 104, 104])
						...
						nn.Conv2d(64, 128, kernel_size=3, bias=False), #torch.Size([1, 128, 52, 52])
						...
						nn.Conv2d(128, 256, kernel_size=3, bias=False), #torch.Size([1, 256, 26, 26])
						...
						nn.Conv2d(256, 512, kernel_size=3, bias=False), #torch.Size([1, 512, 13, 13])
						...
						nn.Conv2d(512, 1024, kernel_size=3, bias=False), #torch.Size([1, 1024, 6, 6])
						...
						nn.Conv2d(1024, 1024, kernel_size=3, bias=False), #torch.Size([1, 1024, 6, 6])
						nn.BatchNorm2d(1024, momentum=0.9, eps=1e-5), #torch.Size([1, 1024, 6, 6])
						nn.LeakyReLU(0.1), #torch.Size([1, 1024, 6, 6])
...
Our_Layer_Model = nn.Sequential(nn.ZeroPad2d((1, 1, 1, 1)),
						GCK3x3Layer(3,16,kernel_size=3, bias=False,result_dim=416),
						...
						GCK3x3Layer(128, 256, kernel_size=3, bias=False, result_dim=26),
						...
						nn.ZeroPad2d((1, 1, 1, 1)),
						GCK3x3Layer(256, 512, kernel_size=3, bias=False, result_dim=13),
                        ...
                        nn.ZeroPad2d((1, 1, 1, 1)),
						GCK3x3Layer(512, 1024, kernel_size=3, bias=False, result_dim=6),
						nn.BatchNorm2d(1024, momentum=0.9, eps=1e-5),
						nn.LeakyReLU(0.1),

                        nn.ZeroPad2d((1, 1, 1, 1)),
						GCK3x3Layer(1024, 1024, kernel_size=3, bias=False, result_dim=6),
						nn.BatchNorm2d(1024, momentum=0.9, eps=1e-5),
						nn.LeakyReLU(0.1),
